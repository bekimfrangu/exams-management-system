	...
	<body class="is-preload landing">
		...
		<div id="main" class="wrapper style1">
			<div class="container">
						...
						<!-- Form -->
						<section>
							<h3>Shto të dhënat e provimit</h3>
							
								<form enctype="multipart/form-data" name="form1" method="post" action="shto_Provim.php" >
									<div class="row gtr-uniform gtr-50">
										<div class="col-6 col-12-xsmall">
											<table border="0">
												...
												<tr> 
													<td>Provimi</td>
													<td><input type="text" name="Emri_Prov"></td>
												</tr>
												<tr> 
													<td>Totali i pyetjeve</td>
													<td><input type="text" name="Totali_Pyetjeve"></td>
												</tr>
												<tr> 
													<td>Kohëzgjatja</td>
													<td><input type="text" name="Kohezgjatja"></td>
												</tr>
												
							
												<tr> 
													<td></td>
													<td><input type="submit" name="shto_Provim" value="Shto"></td>
												</tr>
