									...
									<div class="box alt">
										<div class="row gtr-uniform">
											<section class="col-4 col-6-medium col-12-xsmall">
												<a href="shto_perdorues_forma.php"><span class="icon solid alt major fa-file"></span></a>
												<h3>Shto Përdorues</h3>
												<p>Forma për shtimin e përdoruesve të rinjë në webaplikacion me të drejta të administratorit.</p>
											</section>
											
											<section class="col-4 col-6-medium col-12-xsmall">
												<a href="modifiko_perdorues_forma.php"><span class="icon solid alt major fa-file"></span></a>
												<h3>Modifiko Përdorues</h3>
												<p>Forma për modifikim të përdoruesve aktual në webaplikacion me të drejta të administratorit.</p>
											</section>
											
											<section class="col-4 col-6-medium col-12-xsmall">
												<a href="fshije_perdorues_forma.php"><span class="icon solid alt major fa-file"></span></a>
