		...
		<div id="main" class="wrapper style1">
			<div class="container">
						...
						<section>
								...
								<table>
									<tr>
									<h3>Kërko të dhënat e profesorit për modifikim</h3>
									</tr>
										...
										<tr bgcolor='#CCCCCC'>
											...
											<td>Modifiko</td>
												...
												while($rreshti = mysqli_fetch_array($deklarate)) { 		
														...
														echo "<td><a href=\"modifiko_Profesor.php?ID_Profesori=$rreshti[ID_Profesori]\" class='button' class='button primary'>
														Modifiko</a></td></tr>";	
