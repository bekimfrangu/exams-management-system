		...
		<div id="main" class="wrapper style1">
			<div class="container">
						...
						<section>
								...
								<table>
									<tr>
									<h3>Kërko të dhënat e provimit për fshirje</h3>
									</tr>
										...
										<tr bgcolor='#CCCCCC'>
											...
											<td>Fshijë</td>
												...
												while($rreshti = mysqli_fetch_array($deklarate)) { 		
														...
														echo "<td><a href=\"fshije_Provim.php?ID_Prov=$rreshti[ID_Prov]\" onClick=\"return confirm('A jeni te sigurt se deshironi të fshini provimin?')\" class='button' 
