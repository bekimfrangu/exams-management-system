		...
		<div id="main" class="wrapper style1">
			<div class="container">
						...
						<section>
								...
								<table>
									<tr>
									<h3>Kërko të dhënat e paraqitjes të provimit për modifikim</h3>
									</tr>
										...
										<tr bgcolor='#CCCCCC'>
											...
											<td>Modifiko</td>
												...
												while($rreshti = mysqli_fetch_array($deklarate)) { 		
														...
														echo "<td><a href=\"modifiko_paraqitjetProvimeve.php?ID_Paraqitja=$rreshti[ID_Paraqitja]\" class='button' class='button primary'>
														Modifiko</a></td></tr>";		
													}
